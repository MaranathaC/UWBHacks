export function Hero() {
  return (
    <div className="container mx-auto flex flex-col justify-between clipText font-stacker bg-gradient-to-r from-pink via-purple via-blue to-cyan font-black bg-[size:200%] animate-fadeIn">
      <div className=""></div>
